                    ...
                    <div class="px-3 mb-6  mx-auto w-11/12 bg-white rounded-xl">
                        <div class="sm:flex items-stretch justify-between grow lg:mb-0  py-5 px-5">
                            ...
                            <div class="flex flex-col flex-wrap justify-center mb-5 mr-3 lg:mb-0">
                                <span class="my-0 flex uppercase text-dark font-semibold text-[1.35rem]/[1.2] flex-col justify-center">
                                     {{ __('Homeworks of ') . $course->name }}
                            ...
                            <div class="flex items-center lg:shrink-0 lg:flex-nowrap">
                                ...
                                <div class="relative flex items-center lg:ml-4 sm:mr-0 mr-2">
                                    ...
                                    <form action="{{ route('homeworks.show-homeworks', ['course' => $course]) }}" method="get">
                                        @csrf
                                        <input name="search" class="block w-full min-w-[70px] py-3 pl-12 pr-4 text-base font-medium leading-normal bg-white border border-solid outline-none appearance-none placeholder:text-secondary-dark peer text-stone-500 border-stone-200 bg-clip-padding rounded-2xl" placeholder="Search for name homework..." type="text">
                                    </form>
                                </div>
                                @role('Docente')
                                <div class="flex justify-end ml-10">
                                    <a href="{{ route('homeworks.create', $course) }}" class="inline-flex items-center px-4 py-3 bg-indigo-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                        {{ __('Add') }}
                            ...
                            <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                                ...
                                <div class="mt-8">
                                    ...
                                    <div class="flex space-x-2 text-gray-400 text-sm my-3">
                                        ...
                                        <p>{{ $homework->assigment->grade->name }}</p>
                                    </div>
                                    ...
                                    <div class="flex justify-between">
                                        <div class="my-2">
                                            ...
                                            <div class="flex space-x-2">
                                                <div class="flex">
                                                    <a href="{{ route('homeworks.edit', ['homework' => $homework, 'course' => $course]) }}" class="text-indigo-500 hover:text-indigo-800 text-sm font-medium px-2 py-2 inline-flex space-x-1">
