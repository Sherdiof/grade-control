        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="flex justify-end pb-10">
                    <a href="{{ route('classes.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        {{ __('Add') }}
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                <div class="flex flex-row">
                                    ...
                                    <form method="POST" action="{{route('classes.destroy', $class)}}" class="formulario-eliminar">
                                        @csrf
                                        @method('DELETE')
