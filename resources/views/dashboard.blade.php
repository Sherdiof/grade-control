        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="mt-10">
                    ...
                    <dl class="px-4 mb-5 mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-1">
                        <div class="relative overflow-hidden rounded-lg bg-violet-600 px-4 pb-2 pt-5 shadow sm:px-6 sm:pt-6">
                            <dt>
                                ...
                                <p class="ml-16 truncate text-sm font-medium text-gray-300">Cantidad de cursos asignado</p>
                            </dt>
                            <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                                <p class="text-2xl font-semibold text-gray-100">{{ $coursesTeacher }}</p>
                        ...
                        <div class="relative overflow-hidden rounded-lg bg-fuchsia-600 px-4 pb-2 pt-5 shadow sm:px-6 sm:pt-6">
                            <dt>
                                ...
                                <p class="ml-16 truncate text-sm font-medium text-gray-300">Grados asignados</p>
                            </dt>
                            <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                                <p class="text-2xl font-semibold text-gray-100">{{ $gradesTeacher }}</p>
                                <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                                    <svg class="h-5 w-5 flex-shrink-0 self-center text-green-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z" clip-rule="evenodd" />
                                    </svg>
                        ...
                        <div class="relative overflow-hidden rounded-lg bg-indigo-600 px-4 pb-2 pt-5 shadow sm:px-6 sm:pt-6">
                            <dt>
                                ...
                                <p class="ml-16 truncate text-sm font-medium text-gray-300">Total de tareas creadas</p>
                            </dt>
                            <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
                                <p class="text-2xl font-semibold text-gray-100">{{ $homeworksTeacher }}</p>
