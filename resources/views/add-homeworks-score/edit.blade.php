                    ...
                    <div class="px-3 mb-6  mx-auto w-11/12 bg-white rounded-xl">
                        ...
                        <span
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <form action="{{route('add-homeworks-score.update', ['homework_id' => $homeworkScore->id, 'assigment_id' => $homeworkScore->assigment_id])}}" method="POST">
                                    @csrf
                                    @method('PATCH')
