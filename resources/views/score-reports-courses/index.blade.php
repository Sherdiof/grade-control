    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="m-6">
                    <div class="mb-10">
                        <h2 class=" text-gray-600 text-4xl font-semibold">CUADROS DE ZONA DE LA UNIDAD
                        </h2>
                            ...
                            <div class="w-full px-6 my-4 sm:w-1/2 xl:w-1/3">
                                <div class="flex h-full items-center px-5 py-6 shadow-sm shadow-violet-600 rounded-md bg-violet-200">
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <a href="{{ route('scoreReportsCourse.course', $grade->id) }}" class="text-gray-500">Ver calificaciones</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
