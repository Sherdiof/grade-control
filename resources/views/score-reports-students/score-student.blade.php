<x-app-layout>
    ...
    <div class="flex justify-center">
        <div class="w-full flex justify-center mx-4 rounded shadow mt-7 max-w-xl">
            ...
            <a href="{{ route('scoreReportsStudents.excel', ['grade' => $grade, 'period' => $period, 'student' => $informationStudent->id]) }}" aria-current="page"
            ...
            <a href="{{ route('scoreReportsStudents.pdf', ['grade' => $grade, 'period' => $period, 'student' => $informationStudent->id]) }}" aria-current="false"
